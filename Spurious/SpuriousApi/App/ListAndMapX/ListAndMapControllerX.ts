...
module SpuriousApp {
    ...
    interface IListAndMapControllerX {
        title: string;
        activate: () => void;
    }

    class ListAndMapControllerX implements IListAndMapControllerX {
        title: string;
    ...
    SpuriousApp.controller("ListAndMapControllerX", ListAndMapControllerX);
}